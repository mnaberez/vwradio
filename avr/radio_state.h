...
#define OPERATION_MODE_SETTING_ON_VOL 80
#define OPERATION_MODE_SETTING_CD_MIX 81
#define OPERATION_MODE_SETTING_TAPE_SKIP 82
#define OPERATION_MODE_TESTING_FERN 90
#define OPERATION_MODE_TESTING_RAD 91
#define OPERATION_MODE_TESTING_VER 92
